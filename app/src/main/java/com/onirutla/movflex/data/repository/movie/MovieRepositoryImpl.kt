...
class MovieRepositoryImpl @Inject constructor(
    ...
    override fun getMoviePopularPaging(): Flow<PagingData<MovieResponse>> = Pager(
    ...
    override fun getMoviePopularHome(): Flow<List<MovieResponse>> = flow {
        try {
    ...
    override fun getMovieNowPlayingPaging(): Flow<PagingData<MovieResponse>> = Pager(
        config = PagingConfig(pageSize = NETWORK_LOAD_SIZE, enablePlaceholders = false),
        pagingSourceFactory = {
    ...
    override fun getMovieNowPlayingHome(): Flow<List<MovieResponse>> = flow {
        try {
    ...
    override fun getMovieTopRatedPaging(): Flow<PagingData<MovieResponse>> = Pager(
        config = PagingConfig(pageSize = NETWORK_LOAD_SIZE, enablePlaceholders = false),
        pagingSourceFactory = {
    ...
    override fun getMovieTopRatedHome(): Flow<List<MovieResponse>> = flow {
        try {
    ...
    override fun getMovieUpcomingPaging(): Flow<PagingData<MovieResponse>> = Pager(
        config = PagingConfig(pageSize = NETWORK_LOAD_SIZE, enablePlaceholders = false),
        pagingSourceFactory = {
    ...
    override fun getMovieUpcomingHome(): Flow<List<MovieResponse>> = flow {
        try {
