...
interface TvApiService {
    ...
    suspend fun getTvPopular(@Query(value = "page") page: Int = 1): Response<PageResponse<ItemResponse>>

    @GET(value = "tv/on_the_air")
    suspend fun getTvOnTheAir(@Query(value = "page") page: Int = 1): Response<PageResponse<ItemResponse>>

    @GET(value = "tv/top_rated")
    suspend fun getTvTopRated(@Query(value = "page") page: Int = 1): Response<PageResponse<ItemResponse>>

    @GET(value = "tv/{tv_id}")
    suspend fun getTvDetail(@Path(value = "tv_id") tvId: Int): Response<TvResponseDetail>

    @GET(value = "tv/airing_today")
    suspend fun getTvAiringToday(@Query(value = "page") page: Int = 1): Response<PageResponse<ItemResponse>>
