...
class MovieRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun getMoviePopular(page: Int): List<ItemDto> = try {
    ...
    override suspend fun getMovieNowPlaying(page: Int): List<ItemDto> = try {
    ...
    override suspend fun getMovieTopRated(page: Int): List<ItemDto> = try {
    ...
    override suspend fun getMovieUpcoming(page: Int): List<ItemDto> = try {
